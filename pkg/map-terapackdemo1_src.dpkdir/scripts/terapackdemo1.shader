...
{
	qer_editorimage textures/terapack/text_1
	q3map_lightimage textures/terapack/text_1
	...
	qer_trans 0.5
	{
		...
		map textures/terapack/text_1
		normalMap textures/terapack/text_1
		specularMap textures/terapack/text_1
		blendfunc blend
	}
}
...
{
	qer_editorimage textures/nightskybox/nightskybox_up
